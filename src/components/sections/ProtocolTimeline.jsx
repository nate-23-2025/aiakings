...
const PHASES = [
    {
        ...
        description: 'I audit your current operations, map your ideal client profile, and identify exactly where AI delivers the highest ROI for your business.',
    ...
    },
    {
        number: '02',
        title: 'Build & Train',
        description: 'Custom AI systems built and trained on your voice, your processes, and your client data. No templates. Everything is specific to how you operate.',
    ...
    },
    {
        number: '03',
        title: 'Deployment',
        description: 'Your systems go live. Qualified leads flow to your calendar, operations run automatically, and I monitor and optimize continuously.',
