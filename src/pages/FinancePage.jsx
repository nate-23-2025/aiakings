            ...
            <section ref={heroRef} className="relative min-h-[100dvh] flex flex-col justify-center pb-12 sm:pb-12 md:pb-24 px-4 sm:px-6 md:px-8 lg:px-16 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col lg:flex-row items-end lg:items-center gap-8 lg:gap-12">
                    ...
                    <div className="flex-1 max-w-3xl pointer-events-none">
                        ...
                        <p className="hero-text text-brand-accent uppercase tracking-[0.2em] font-mono text-[10px] mb-2 md:mb-4 pointer-events-auto">
                        ...
                        {/* Drama text */}
                        <h2 className="hero-text hero-accent-glow text-4xl sm:text-4xl md:text-7xl lg:text-[9rem] leading-[0.9] drama-text text-brand-accent mb-3 sm:mb-3 md:mb-8 pointer-events-auto">
                            Without Hiring.
                        </h2>
                        ...
                        {/* Dual CTA */}
                        <div className="hero-cta flex flex-col sm:flex-row flex-wrap gap-2.5 sm:gap-4 items-stretch sm:items-center mb-3 sm:mb-3 pointer-events-auto">
